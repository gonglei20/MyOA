...
$(function() {
	...
	<body>
		...
		<form id="myForm" name="myForm" action="editRootData.do" method="post">
 					...
 					<div class="action">
						...
						<div class="pages">
							<table width="90%" border="0" cellspacing="0" cellpadding="0">
								<tr >
									<td align="right" width="30%">用户名：</td><td  align="left"><input type="text" name="username" value="${sessionUser.username }"  id="username"/></td>
								</tr>
								
								<tr >
									<td align="right" width="30%">密码：</td><td  align="left"><input type="text" name="password" value="${sessionUser.password }"  id="password"/></td>
								</tr>
								
								<tr >
									<td align="center" colspan="2"><br/><input type="submit"  id="save" value="保存数据"  />
									<a href="forwardPersonAccount.do"><input type="button"  id="back" value="返回"  /></a></td>
								</tr>
