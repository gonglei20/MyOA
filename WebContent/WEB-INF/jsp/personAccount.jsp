 					...
 					<div class="action">
						...
						<div class="pages">
							<table width="90%" border="0" cellspacing="0" cellpadding="0">
								...
								<tr >
									<td align="right" width="30%">密码：</td><td  align="left"><input type="text" name="password" value="${sessionUser.password }" readonly="readonly" id="u_mobile"/></td>
								</tr>
								
								<tr >
									<td align="center" colspan="2"><br/><a href="forwardEditPersonAccount.do"><input type="button"  id="save" value="编辑数据"  /></a></td>
								</tr>
